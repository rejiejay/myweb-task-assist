        ...
        return <div className="pagination flex-center noselect">
            <div className="flex-start-center">
                ...
                <div className="list-pagination-item list-pagination-right flex-center"
                    onClick={this.nextPageHandle/** 下一页 */}
                >
                ...
                <div className="list-pagination-input flex-start-center">
                    <div className="pagination-input-container">
                        <input
                            ...
                            onChange={this.jumpPageNoInputHandle}
                        />
                    </div>
...
const PaginationSelected = ({ self, pageNo, pageTotal }) => {

    const renderByArray = pages => pages.map(thisNo => <div key={`pageNo${thisNo}${StringHelper.createRandomStr({ length: 4 })}`}
    ...
    const firstPage = <div className="list-pagination-item" key={`${StringHelper.createRandomStr({ length: 16 })}`}
        onClick={() => self.pageNoChangeHandle(1)}
    >1</div>

    const lastPage = <div className="list-pagination-item" key={`${StringHelper.createRandomStr({ length: 16 })}`}
