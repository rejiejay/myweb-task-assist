export default class Header extends React.Component {
    ...
    render() {
        const { title, addLongTermDetailProgramHandle } = this.props
        ...
        return <>
            <div className='header-top-left flex-rest flex-start'>
                <div className='top-left-item flex-start-center' onClick={() => window.history.back()}>
                    ...
                    <div className='left-item-name'>{title}</div>
                </div>
            </div>

            <div className='header-top-right flex-start'>
                <div className='top-right-item' onClick={addLongTermDetailProgramHandle}>新增</div>
            </div>
        </>
    }
}
